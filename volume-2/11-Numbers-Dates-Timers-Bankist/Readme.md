...
- So basically, always as decimals no matter if we actually write them as integer or as decimals. `console.log(23 === 23.0); // true`
...
**_Converting string number to Number_**:
...
**_Parsing String to Number_**:

- **_parseInt()_** : parsing string to integer.
- **_parseFloat()_**: parsing string to decimals.
...
- **_setTimeout()_**:
  ...
  - **_clearTimeout()_**: for deletes the timeout.
- **_setInterval()_**:
